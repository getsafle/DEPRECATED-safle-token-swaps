module.exports = {
  ...
  KYBER_CURRENCY_URL:
    process.env.KYBER_CURRENCY_URL ||
    'https://ropsten-api.kyber.network/currencies',
  KYBER_GET_GAS_LIMIT_URL:
    process.env.KYBER_GET_GAS_LIMIT_URL ||
    'https://ropsten-api.kyber.network/gas_limit',
  REF_ADDRESS:
    process.env.REF_ADDRESS || '0x0000000000000000000000000000000000000000',
  ETH_TOKEN_ADDRESS:
  ...
  ETHERSCAN_ROPSTEN_SERVICE_URL:
    process.env.ETHERSCAN_ROPSTEN_SERVICE_URL ||
